...
const DTSFiles = [
    ...
    'BMView/BMDragSession.js',
    'BMView/BMDragSessionDelegates.js',
    'BMView/BMDragSessionActions.js',
    'BMView/BMDragSessionPreview.js',
    ...
    'BMViewLayoutEditor/BMLayoutEditorDelegate.js', 
    'BMViewLayoutEditor/BMLayoutEditorSettingCells.js', 
